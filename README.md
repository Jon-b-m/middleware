...
<B>Please do not change TDD = 0, because that will result in doubling your TDD, since it counts from 0. This middleware requires 24 hours of pump history data for an accurate TDD count. Please note that the TDD calculation has only been tested with Omnipod. </B>
